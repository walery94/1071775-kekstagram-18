...
(function () {
  ...
  var popularFilterButtonHandler = function () {
  ...
  var randomFilterButtonHandler = function () {
  ...
  var discussedFilterButtonHandler = function () {
  ...
  filterButtonsBlock.addEventListener('click', function (evt) {
    if (evt.target.classList.contains('img-filters__button') && !evt.target.classList.contains(window.constants.ACTIVE_CLASS_FILTER)) {
      ...
      switch (evt.target.id) {
        case 'filter-popular':
          functionToCall = popularFilterButtonHandler;
          break;
        case 'filter-random':
          functionToCall = randomFilterButtonHandler;
          break;
        case 'filter-discussed':
          functionToCall = discussedFilterButtonHandler;
          break;
      }
      if (functionToCall) {
